...
const TRANSLATIONS: Partial<Record<LanguageCode, Record<string, string>>> = {
  es: {
    ...
    "Good morning": "Buenos días", "Good afternoon": "Buenas tardes", "Good evening": "Buenas noches", "Talk to Ada": "Hablar con Ada", "Talk to": "Hablar con",
    "Your health memory, in your voice.": "Tu memoria de salud, en tu voz.", "How are you feeling today?": "¿Cómo te sientes hoy?",
    "New to CareEcho?": "¿Nuevo en CareEcho?", "Load a sample week to explore.": "Carga una semana de ejemplo para explorar.", "Try Demo": "Probar demo",
    "This week": "Esta semana", "See details": "Ver detalles", "report": "registro", "reports": "registros", "No reports": "Sin registros",
    "Last update": "Última actualización", "Nothing yet": "Aún nada", "Last visit": "Última visita", "Health timeline": "Cronología de salud",
    "Reported": "Registrado:", "Consultation saved": "Consulta guardada", "Ask Ada about your visit": "Pregunta a Ada sobre tu consulta",
    "health notes": "notas de salud", "visits": "visitas", "voice, memory & answers": "voz, memoria y respuestas",
    "Everything you told Ada — and what your doctor said.": "Todo lo que le contaste a Ada y lo que dijo tu médico.",
    "Tell Ada how you feel to start your health memory.": "Cuéntale a Ada cómo te sientes para empezar tu memoria de salud.",
    "Your consultations": "Tus consultas", "CareEcho can record and remember your consultation.": "CareEcho puede grabar y recordar tu consulta.",
    "Transcribed by AssemblyAI, with speaker labels.": "Transcrito por AssemblyAI, con etiquetas de hablantes.",
    "Ada saves medications, follow-ups and instructions — each linked to the exact words.": "Ada guarda medicamentos, seguimientos e instrucciones, vinculados a las palabras exactas.",
    "Stored only on this device.": "Guardado solo en este dispositivo.", "Make sure everyone being recorded has agreed.": "Asegúrate de que todos los grabados hayan dado su consentimiento.",
    "Start visit": "Iniciar consulta", "Saved visits": "Consultas guardadas", "Consultation": "Consulta", "saved items": "elementos guardados",
    "questions": "preguntas", "No source → no claim": "Sin fuente, no hay afirmación",
    "Ada only keeps what your clinician actually said. Things you said stay marked as yours — they never become instructions.": "Ada solo conserva lo que realmente dijo tu profesional de salud. Lo que tú dijiste queda marcado como tuyo y nunca se convierte en una instrucción.",
    "Load demo recording (sample consultation)": "Cargar grabación demo (consulta de ejemplo)",
    REC: "GRABANDO", Sample: "Ejemplo",
  },
  fr: {
