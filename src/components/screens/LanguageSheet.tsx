...
export function LanguageSheet() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-[13px] text-mute">Choose the language you speak with Ada. Voice notes, visits, and answers follow your selection.</p>
          ...
          <li key={l.code}>
            ...
            >
              <span>
                ...
                <span className="block text-[11.5px] text-mute">{l.name} · voice, memory & answers</span>
              </span>
              {language === l.code ? (
                ...
                <span className="text-[11px] font-bold uppercase tracking-wider text-mute">Select</span>
              )}
            </button>
          </li>
        ))}
